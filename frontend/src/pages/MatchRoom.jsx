      ...
      <div style={styles.editorContainer}>
        <div style={styles.editorHeader}>
          ...
          <div style={styles.editorInfo}>
            <span style={styles.infoText}>👥 User: {user.user.username}</span>
            <span style={styles.infoText}>🔢 Lines: {code.split('\n').length}</span>
            <span style={styles.infoText}>📊 Characters: {code.length}</span>
          </div>
        </div>
